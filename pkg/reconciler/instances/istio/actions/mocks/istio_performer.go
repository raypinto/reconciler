...
// Downgrade provides a mock function with given fields: kubeConfig, manifest, logger
func (_m *IstioPerformer) Downgrade(kubeConfig string, manifest string, logger *zap.SugaredLogger) error {
...
// Upgrade provides a mock function with given fields: kubeConfig, manifest, logger
func (_m *IstioPerformer) Upgrade(kubeConfig string, manifest string, logger *zap.SugaredLogger) error {
	ret := _m.Called(kubeConfig, manifest, logger)
